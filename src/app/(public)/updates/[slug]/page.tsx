...
export default function UpdateDetailPage() {
  ...
  useEffect(() => {
    const item = store.updates.find((u) => u.slug === slug);
  ...
  if (!updateItem) {
    return (
      <div className="py-20 max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-sm text-slate-500 mt-2">The update you are looking for may have been archived or removed.</p>
        <Link
          href="/updates"
    ...
    <div className="py-10 bg-slate-50 min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <article className="bg-white border border-brand-border rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
          ...
          {/* Title (Single H1 per page for SEO) */}
